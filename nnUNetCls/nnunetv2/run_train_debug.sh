...
#nohup nnUNetv2_train 100 3d_fullres 0 --npz -tr nnUNetTrainer -p nnUNetResEncUNetMPlans -num_gpus 2 >> log_train_086_3d_fullres_0.txt &

rm log_train_100_3d_fullres_cls_0.txt
nohup nnUNetv2_train 100 3d_fullres 0 --npz -tr nnUNetClsTrainer -p nnUNetResEncUNetMCLSPlans -num_gpus 2 >> log_train_086_3d_fullres_cls_0.txt &
