...
rm log_train_100_3d_fullres_cls_0_debug.txt
nohup nnUNetv2_train 100 3d_fullres 0 --npz -tr nnUNetClsTrainerDEBUG -p nnUNetResEncUNetMCLSPlans >> log_train_100_3d_fullres_cls_0_debug.txt &
